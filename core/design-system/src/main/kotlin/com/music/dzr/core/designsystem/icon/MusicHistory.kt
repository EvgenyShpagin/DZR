...
val MusicHistory: ImageVector
    get() {
        if (_musicHistory != null) return _musicHistory!!

        _musicHistory = ImageVector.Builder(
            name = "DzrIcons.MusicHistory",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            viewportHeight = 960f
        ...
        return _musicHistory!!
    }

private var _musicHistory: ImageVector? = null
