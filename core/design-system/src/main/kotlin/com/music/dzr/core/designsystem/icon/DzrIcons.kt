...
object DzrIcons {
    ...
    val LockPerson get() = Icons.Sharp.LockPerson
    val DoneAll get() = Icons.Sharp.DoneAll
    val RemoveDone get() = Icons.Sharp.RemoveDone
    val AccountCircle get() = DzrAccountCircle
    val AlternateEmail get() = Icons.Sharp.AlternateEmail
    val PlayCircle get() = Icons.Sharp.PlayCircleOutline
    val History get() = Icons.Sharp.History
    val QueueMusic get() = Icons.AutoMirrored.Sharp.QueueMusic
    val SkipNext get() = Icons.Sharp.SkipNext
    val SettingsRemote get() = Icons.Sharp.SettingsRemote
    val LibraryMusic get() = Icons.Sharp.LibraryMusic
    val Edit get() = Icons.Sharp.Edit
