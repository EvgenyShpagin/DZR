...
@PreviewLightDark
@Composable
private fun PlayableHeader_WithButton_Preview() {
    DzrTheme {
        PlayableHeader(
            title = "Hits",
            onPlayClick = {},
...
@Composable
private fun PlayableHeader_FontScale_1_5_Preview() {
    DzrTheme {
        PlayableHeader(
            title = "Greatest Hits",
            subtitle = "The Beatles",
...
@PreviewLightDark
@Composable
private fun PlayableHeader_ComplexContent_Preview() {
    DzrTheme {
        PlayableHeader(
            title = "Greatest Hits",
            subtitle = "The Beatles",
...
@Preview
@Composable
private fun PlayableHeader_NoSubtitle_Preview() {
    DzrTheme {
        PlayableHeader(
            title = "My Favorites",
            onPlayClick = {},
...
@Composable
private fun PlayableHeader_SmallScreen_Preview() {
    DzrTheme {
        PlayableHeader(
            title = "Greatest Hits",
            subtitle = "The Beatles",
