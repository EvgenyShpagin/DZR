...
class ArtistApiTest {
    ...
    fun getArtist_returnsData_onRequest() = runTest {
        // Arrange
        server.enqueueResponseFromAssets("artist_response.json")
    ...
    fun getMultipleArtists_returnsData_onRequest() = runTest {
        // Arrange
        server.enqueueResponseFromAssets("multiple_artists_response.json")
    ...
    fun getArtistAlbums_returnsData_onRequestWithAllParams() = runTest {
        // Arrange
        server.enqueueResponseFromAssets("artist_albums_response.json")
    ...
    fun getArtistTopTracks_returnsData_onRequestWithMarket() = runTest {
        // Arrange
        server.enqueueResponseFromAssets("artist_top_tracks_response.json")
        val market = "CA"
